...
public class FacilityBarCheckDateVO {
	...
	public String toString() {
		return "FacilityBarCheckDateVO [IDX=" + IDX + ", ACHECK=" + ACHECK + ", BCHECK=" + BCHECK + ", CCHECK=" + CCHECK
				...
				+ ", bRamUsrQnt=" + bRamUsrQnt + ", bHddUseQnt=" + bHddUseQnt + ", bHddUseQnt2=" + bHddUseQnt2 + ", bHddUseQnt3=" + bHddUseQnt3 +",  bVdoFileYn=" +bVdoFileYn+"]";
	}
