...
public class FacilityCheckDateVO {
	...
	public String toString() {
		return "FacilityCheckDateVO [IDX=" + IDX + ", ACHECK=" + ACHECK + ", BCHECK=" + BCHECK + ", CCHECK=" + CCHECK
				...
				+ ", bRamUsrQnt=" + bRamUsrQnt + ", bHddUseQnt=" + bHddUseQnt + ", fcl_NM=" + fcl_NM + "]";
	}
