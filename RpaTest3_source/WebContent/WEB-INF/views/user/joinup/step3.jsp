...
<div id="wrap">
    ...
    <div class="joinWap">
        <div class="joinIn">
            ...
            <div class="joinFi">
                <div class="joinFiTit">
                    <h1><i></i><span>무인보안시스템 설비점검 효율화</span></h1>
                    <div class= "joinFiTextBox">
                        <h2>회원가입 <span>완료</span></h2>
                        <p class="infoText">회원 가입이 완료 되었습니다. 로그인 후 이용 부탁드립니다.</p>
                    </div>            
                    <a href="/loginIn" class="btn_loginGo">로그인 페이지로 이동</a>
                </div>                
            </div>
            <!--//joinFi-->
        </div>
    ...
    <footer id="footer">
        <div class="footerIn">
            ...
            <div class="footQna"><span class="txt_tit">업무문의</span> <span class="txt_depart">부서명</span><span class="txt_tel">061-1234</span></div>
            <div class="footQna m-l-125"><span class="txt_tit">시스템문의</span> <span class="txt_depart">부서명</span><span class="txt_tel">061-1234</span></div>
        </div>
    </footer>
    <!--//footer--> 
</div>
